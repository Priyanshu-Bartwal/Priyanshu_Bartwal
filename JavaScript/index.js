...
let img = document.getElementById("imgTransition");
let content = document.getElementById("contentTransition");
let screen = document.getElementById("swiper");
...
// const transition = ()=>{
//     img.classList.toggle("imgTransition");
//     content.classList.toggle("contentTransition");
//     console.log("hello")
// }
// screen.classList.toggle("blackScreen");
